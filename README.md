...
reference registry where the full pipeline still lost to plain dense
embedding, p=0.00053). See `docs/operations.md` §8 for the full
lock-semantics discussion.
